...
export default function Gallery() {
  ...
  const scrollToItem = (direction: "prev" | "next") => {
    ...
    gsap.to(trackRef.current, {
      scrollLeft:
        itemWidth * newIndex - trackRef.current.clientWidth / 2 + itemWidth / 2,
      duration: 0.6,
      ease: "expo.out",
    });
  };
        ...
        >
          <div>
            <h2 className="text-section text-[#1D1D1F] mb-2">
              Feito com o Vision Pro.
            </h2>
            <p className="text-body-large">
              Veja o que o novo sistema de câmera pode fazer.
            </p>
          </div>
        ...
        {galleryItems.map((_, index) => (
          <button
            ...
            onClick={() => {
              ...
              if (trackRef.current) {
                const itemWidth =
                  trackRef.current.scrollWidth / galleryItems.length;
                gsap.to(trackRef.current, {
                  scrollLeft:
                    itemWidth * index -
